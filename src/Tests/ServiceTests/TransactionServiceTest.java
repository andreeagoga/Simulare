...
//        Transaction transaction2 = new Transaction(2, 2, 1, 6, "12.12.2012", "10:00", true);
//
//        transactionService.addAndUpdate(1, 1, 1, 5, "12.12.2012", "10:00", true);
//        transactionService.addAndUpdate(2, 2, 1, 6, "12.12.2012", "10:00", false);
...
//        InMemoryRepository repositoryM = new InMemoryRepository(validator);
//        TransactionService transactionService = new TransactionService(repositoryT, repositoryM);
//        Transaction transaction3 = new Transaction(5, 1, 1, 5, "12.12.2012", "10:00 1", true);
//        Transaction transaction4 = new Transaction(6, 1, 1, 5, "12.12.2012", "10:00 2", true);
//
//        transactionService.addAndUpdate(5, 1, 1, 5, "12.12.2012", "10:00 1", false);
//        transactionService.addAndUpdate(6, 1, 1, 5, "12.12.2012", "10:00 2", false);
